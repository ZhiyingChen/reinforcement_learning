...
if __name__ == "__main__":
    ...
    planner = PGACPlanner(env, PGACConfig(log_dir="logs/ch10_offac"))
    theta, w, pi = planner.off_policy_actor_critic(
        num_episodes=6000, behavior_epsilon=0.4, rho_clip=5.0
    )
